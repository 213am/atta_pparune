      ...
      <div className="flex flex-col w-full h-dvh justify-start items-center gap-10">
        ...
        <div className="flex flex-col w-full h-[30%] px-10 gap-4 border-b border-gray">
          ...
          <div className="flex flex-col w-full gap-2">
            ...
            <div className="flex gap-2 items-center">
              <span className="w-[25%] text-nowrap text-darkGray">연락처</span>
              <span className="w-[75%] text-nowrap text-xl">010-1234-5678</span>
            </div>
            <div className="flex gap-2 items-center">
              <span className="w-[25%] text-nowrap text-darkGray">인원 수</span>
